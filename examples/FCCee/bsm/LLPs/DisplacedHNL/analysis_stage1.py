...
class RDFanalysis():
		...
		.Define("FSGenLepton_phi_sub",    " if (n_FSGenLepton>1) return FSGenLepton_phi.at(1); else return float(-1000.);") #polar angle in the transverse plane phi
                ...
                .Define("MC_PrimaryVertex",  "FCCAnalyses::MCParticle::get_EventPrimaryVertex(21)( Particle )" )
					...
					.Define("FSGenTotal_e", "return float(FSGenLepton_e + FSGenNeutrino_e)") ## ## se fa 91Gev => FSGenLepton_e e Neutrino_e sono le energie totali di tutti i leptoni e enutrini generati
