...
inputDir = "/eos/user/e/espoto/H_pole/FCCAnalyses/reco/stage1_reco/"

#Output directory where the files produced at the final-selection level are
outputDir = "/eos/user/e/espoto/H_pole/FCCAnalyses/reco/final_reco/"
...
processList = {
    ...
    #backgrounds
    'wzp6_ee_Htautau_ecm125':{},
	'wzp6_ee_tautau_ecm125':{},
	'wzp6_ee_Hllnunu_ecm125':{}, #cross section: 0.00003187
	'wzp6_ee_l1l2nunu_ecm125':{}, #cross section: 0.009845
	'wzp6_ee_tautaununu_ecm125':{}, #cross section: 0.04265
	'wzp6_ee_eenunu_ecm125':{}, #cross section: 0.6574
	'wzp6_ee_mumununu_ecm125':{}, #cross section: 0.2202
	#'p8_ee_Z_Ztautau_ecm125':{}, #cross section: 26  # Error with this line: "Can't find the YAML file with process info for process "p8_ee_Z_Ztautau_ecm125"!"
	#'p8_ee_Z_Zqq_ecm125':{}, #cross section: 237 	# Error with this line: "Can't find the YAML file with process info for process "p8_ee_Z_Ztautau_ecm125"!"
...
procDictAdd = {
	...
	## ## cross section found by madgraph, espoto:
	'HNL_1.04e-8_30gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 6.476e-08, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_1.04e-8_60gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 4.774e-08, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_1.04e-8_90gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 3.048e-08, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_1.04e-8_110gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 5.669e-09, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_1.04e-8_120gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 6.931e-10, "kfactor": 1.0, "matchingEfficiency": 1.0},

	'HNL_4e-10_30gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 3.886e-09, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_4e-10_60gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 2.913e-09, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_4e-10_90gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 1.941e-09, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_4e-10_110gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 3.888e-10, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_4e-10_120gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 5.067e-11, "kfactor": 1.0, "matchingEfficiency": 1.0},

	'HNL_6.67e-10_30gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 4.154e-09, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_6.67e-10_60gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 3.067e-09, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_6.67e-10_90gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 1.95e-09, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_6.67e-10_110gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 3.64e-10, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_6.67e-10_120gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 4.445e-11, "kfactor": 1.0, "matchingEfficiency": 1.0},

	'HNL_8.35e-9_30gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 1.099e-07, "kfactor": 1.0, "matchingEfficiency": 1.0},
	'HNL_8.35e-9_60gev':{"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 8.291e-08, "kfactor": 1.0, "matchingEfficiency": 1.0},
...
cutList = {
    ...
    #"selReco":"true",
	"selReco_15MET_08cos_64D0_1pt_2el": "RecoEmiss_pt>15 && Reco_cos>-0.8 && (Reco_pt.at(0)+Reco_pt.at(1))>1 && (Reco_e.at(0)+Reco_e.at(1))>2 && RecoTrack_absD0_lead.at(0)>0.64 && RecoTrack_absD0_sub.at(0)>0.64 && RecoDecayVertexLepton.chi2<10",
...
cutLabels = {
	...
	"selReco_15MET_08cos_64D0_1pt_2el":"cuts on paper",
...
histoList = {
    ...
    "RecoElectron_e":        {"name":"RecoElectron_e",        "title":"Reco electron energy [GeV]", "bin":100,"xmin":0 ,"xmax":70},
    "RecoElectron_p":        {"name":"RecoElectron_p",        "title":"Reco electron p [GeV]",      "bin":100,"xmin":0 ,"xmax":70},
    "RecoElectron_pt":       {"name":"RecoElectron_pt",       "title":"Reco electron p_{T} [GeV]",  "bin":100,"xmin":0 ,"xmax":70},
    "RecoElectron_px":       {"name":"RecoElectron_px",       "title":"Reco electron p_{x} [GeV]",  "bin":100,"xmin":-50 ,"xmax":70},
    "RecoElectron_py":       {"name":"RecoElectron_py",       "title":"Reco electron p_{y} [GeV]",  "bin":100,"xmin":-50 ,"xmax":70},
    "RecoElectron_pz":       {"name":"RecoElectron_pz",       "title":"Reco electron p_{z} [GeV]",  "bin":100,"xmin":-50 ,"xmax":70},
	...
	"RecoMuon_e":        {"name":"RecoMuon_e",        "title":"Reco muon energy [GeV]", "bin":100,"xmin":0 ,"xmax":70},
    "RecoMuon_p":        {"name":"RecoMuon_p",        "title":"Reco muon p [GeV]",      "bin":100,"xmin":0 ,"xmax":70},
    "RecoMuon_pt":       {"name":"RecoMuon_pt",       "title":"Reco muon p_{T} [GeV]",  "bin":100,"xmin":0 ,"xmax":70},
    "RecoMuon_px":       {"name":"RecoMuon_px",       "title":"Reco muon p_{x} [GeV]",  "bin":100,"xmin":-50 ,"xmax":70},
    "RecoMuon_py":       {"name":"RecoMuon_py",       "title":"Reco muon p_{y} [GeV]",  "bin":100,"xmin":-50 ,"xmax":70},
    "RecoMuon_pz":       {"name":"RecoMuon_pz",       "title":"Reco muon p_{z} [GeV]",  "bin":100,"xmin":-50 ,"xmax":70},
    ...
    "NeutralHadrons_e":        {"name":"NeutralHadrons_e",        "title":"Reco neutral hadron energy [GeV]", "bin":100,"xmin":0 ,"xmax":70},
    "NeutralHadrons_p":        {"name":"NeutralHadrons_p",        "title":"Reco neutral hadron p [GeV]",      "bin":100,"xmin":0 ,"xmax":70},
    "NeutralHadrons_px":        {"name":"NeutralHadrons_px",        "title":"Reco neutral hadron px [GeV]",      "bin":100,"xmin": -50,"xmax":70},
    "NeutralHadrons_py":        {"name":"NeutralHadrons_py",        "title":"Reco neutral hadron py [GeV]",      "bin":100,"xmin":-50 ,"xmax":70},
    "NeutralHadrons_pz":        {"name":"NeutralHadrons_pz",        "title":"Reco neutral hadron pz [GeV]",      "bin":100,"xmin":-50 ,"xmax":70},
    "NeutralHadrons_pt":       {"name":"NeutralHadrons_pt",       "title":"Reco neutral hadron p_{T} [GeV]",  "bin":100,"xmin":0 ,"xmax":70},
    ...
    "Reco_e":                   {"name":"Reco_e",         "title":"Reco lepton energy [GeV]",       "bin":100,"xmin":0 ,"xmax":70},
    "Reco_p":                   {"name":"Reco_p",         "title":"Reco lepton p [GeV]",            "bin":100,"xmin":0 ,"xmax":70},
    "Reco_pt":                  {"name":"Reco_pt",        "title":"Reco lepton p_{T} [GeV]",        "bin":100,"xmin":0 ,"xmax":70},
    "Reco_px":                  {"name":"Reco_px",        "title":"Reco lepton p_{x} [GeV]",        "bin":100,"xmin":-50 ,"xmax":70},
    "Reco_py":                  {"name":"Reco_py",        "title":"Reco lepton p_{y} [GeV]",        "bin":100,"xmin":-50 ,"xmax":70},
    "Reco_pz":                  {"name":"Reco_pz",        "title":"Reco lepton p_{z} [GeV]",        "bin":100,"xmin":-50 ,"xmax":70},
    ...
    "Reco_Lxy_prompt":              {"name":"Reco_Lxy",                    "title":"Reco L_{xy} [mm]",     "bin":100,"xmin":0 ,"xmax":20},
    "Reco_Lxyz":                    {"name":"Reco_Lxyz",                   "title":"Reco L_{xyz} [mm]",    "bin":100,"xmin":0 ,"xmax":2000},
    "Reco_Lxyz_prompt":             {"name":"Reco_Lxyz",                   "title":"Reco L_{xyz} [mm]",    "bin":100,"xmin":0 ,"xmax":20},
    ...
    "Reco_invMass":     {"name":"Reco_invMass",     "title":"Reco M(l,l') [GeV]",            "bin":100,"xmin":0, "xmax":130},
    ...
    "RecoMissingEnergy_e":       {"name":"RecoMissingEnergy_e",       "title":"Reco Total Missing Energy [GeV]",    "bin":100,"xmin":0 ,"xmax":70},
    "RecoMissingEnergy_p":       {"name":"RecoMissingEnergy_p",       "title":"Reco Total Missing p [GeV]",         "bin":100,"xmin":0 ,"xmax":70},
    "RecoMissingEnergy_pt":      {"name":"RecoMissingEnergy_pt",      "title":"Reco Missing p_{T} [GeV]",           "bin":100,"xmin":0 ,"xmax":70},
    "RecoMissingEnergy_px":      {"name":"RecoMissingEnergy_px",      "title":"Reco Missing p_{x} [GeV]",           "bin":100,"xmin":-50 ,"xmax":70},
    "RecoMissingEnergy_py":      {"name":"RecoMissingEnergy_py",      "title":"Reco Missing p_{y} [GeV]",           "bin":100,"xmin":-50 ,"xmax":70},
    "RecoMissingEnergy_pz":      {"name":"RecoMissingEnergy_pz",      "title":"Reco Missing p_{z} [GeV]",           "bin":100,"xmin":-50 ,"xmax":70},
    ...
    "RecoEmiss_e":       {"name":"RecoEmiss_e",       "title":"Reco Total Missing Energy [GeV]",    "bin":100,"xmin":0 ,"xmax":130},
    "RecoEmiss_p":       {"name":"RecoEmiss_p",      "title":"Reco Missing p [GeV]",           "bin":100,"xmin":0 ,"xmax":70},
    "RecoEmiss_pt":      {"name":"RecoEmiss_pt",      "title":"Reco Missing p_{T} [GeV]",           "bin":100,"xmin":0 ,"xmax":70},
    "RecoEmiss_px":      {"name":"RecoEmiss_px",      "title":"Reco Missing p_{x} [GeV]",           "bin":100,"xmin":-50 ,"xmax":70},
    "RecoEmiss_py":      {"name":"RecoEmiss_py",      "title":"Reco Missing p_{y} [GeV]",           "bin":100,"xmin":-50 ,"xmax":70},
    "RecoEmiss_pz":      {"name":"RecoEmiss_pz",      "title":"Reco Missing p_{z} [GeV]",           "bin":100,"xmin":-50 ,"xmax":70},

    #"noLep_e":                   {"name":"noLep_e",         "title":"Reco non lepton energy [GeV]",       "bin":100,"xmin":0 ,"xmax":70},
    #"noLep_p":                   {"name":"noLep_p",         "title":"Reco non lepton p [GeV]",            "bin":100,"xmin":0 ,"xmax":70},
    #"noLep_pt":                  {"name":"noLep_pt",        "title":"Reco non lepton p_{T} [GeV]",        "bin":100,"xmin":0 ,"xmax":70},
    #"noLep_px":                  {"name":"noLep_px",        "title":"Reco non lepton p_{x} [GeV]",        "bin":100,"xmin":-50 ,"xmax":70},
    #"noLep_py":                  {"name":"noLep_py",        "title":"Reco non lepton p_{y} [GeV]",        "bin":100,"xmin":-50 ,"xmax":70},
    #"noLep_pz":                  {"name":"noLep_pz",        "title":"Reco non lepton p_{z} [GeV]",        "bin":100,"xmin":-50 ,"xmax":70},
