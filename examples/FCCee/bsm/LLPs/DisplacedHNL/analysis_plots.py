...
outdir         = '/eos/user/e/espoto/H_pole/FCCAnalyses/gen/plots_gen_3.17e-11/'
formats        = ['png']
#formats        = ['pdf']
#yaxis          = ['lin','log']
yaxis          = ['log']
...
colors['HNL_3.17e-11_30gev'] = ROOT.kMagenta-5 ## ## mod edo
...
legend['HNL_3.17e-11_30gev'] = 'U^{2}=3.17e-11, M_{N}=30 GeV' ## mod edo
