...
outdir         = '/eos/user/e/espoto/H_pole/FCCAnalyses/reco/plots_reco/HNL_110gev/'
formats        = ['png']
#formats        = ['pdf']
#yaxis          = ['lin','log']
yaxis          = ['log']
...
colors['HNL_1.04e-8_110gev'] = ROOT.kCyan-7 ## ## modificato da me
colors['HNL_4e-10_110gev'] = ROOT.kAzure+5
colors['HNL_6.67e-10_110gev'] = ROOT.kBlue-7
colors['HNL_8.35e-9_110gev'] = ROOT.kOrange-2
colors['HNL_2.27e-9_110gev'] = ROOT.kOrange+8
colors['HNL_3.17e-11_110gev'] = ROOT.kBlue-4
...
legend['HNL_4e-10_110gev'] = 'U^{2}=4e-10, M_{N}=110 GeV'
legend['HNL_6.67e-10_110gev'] = 'U^{2}=6.67e-10, M_{N}=110 GeV'
