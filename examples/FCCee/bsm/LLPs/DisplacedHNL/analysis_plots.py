...
outdir         = '/eos/user/e/espoto/FCC_2jet_z_pole/FCCAnalysis/plots_reco/'
formats        = ['png']
#formats        = ['pdf']
#yaxis          = ['lin','log']
yaxis          = ['log']
...
variables = [
	...
	"Reco_DecayVertexMuon_lead_z_0P",
	"Reco_DecayVertexMuon_lead_0P.chi2",
	"Log_chi2_0P",
	"Reco_Lxyz_0P",
	"Reco_Lxyz_prompt_0P",

	"Reco_DecayVertexMuon_lead_z_2P",
	"Reco_DecayVertexMuon_lead_2P.chi2",
	"Log_chi2_2P",
	"Reco_Lxyz_2P",
	"Reco_Lxyz_prompt_2P",

	"Reco_DecayVertexMuon_lead_z_0S",
	"Reco_DecayVertexMuon_lead_0S.chi2",
	"Log_chi2_0S",
	"Reco_Lxyz_0S",
	"Reco_Lxyz_prompt_0S",

	"Reco_DecayVertexMuon_lead_z_1S",
	"Reco_DecayVertexMuon_lead_1S.chi2",
	"Log_chi2_1S",
	"Reco_Lxyz_1S",
	"Reco_Lxyz_prompt_1S",

	"Reco_DecayVertexMuon_lead_z_2S",
	"Reco_DecayVertexMuon_lead_2S.chi2",
	"Log_chi2_2S",
	"Reco_Lxyz_2S",
	"Reco_Lxyz_prompt_2S",
]
