...
outdir         = '/eos/user/e/espoto/FCC_2jet_z_pole/FCCAnalysis/plots_reco/toshow_PV_and_secondC'
formats        = ['png']
#formats        = ['pdf']
#yaxis          = ['lin','log']
yaxis          = ['log']
...
variables = [
	...
	#"Reco_DecayVertexMuon_lead.chi2",
	#"n_RecoTracks",
	#"n_PrimaryTracks",
	#"n_SecondaryTracks",
	#"Reco_Lxy",
...
colors['HNL_4e-10_10gev'] = ROOT.kAzure+5
colors['HNL_4e-10_10gev'] = ROOT.kBlue-7
colors['HNL_6.67e-10_10gev'] = ROOT.kOrange-2
colors['HNL_8.35e-9_10gev'] = ROOT.kOrange+8
colors['HNL_2.27e-9_10gev'] = ROOT.kBlue-4
colors['HNL_1.04e-8_10gev'] = ROOT.kRed-4
colors['HNL_2.27e-9_10gev'] = ROOT.kBlue-4
colors['HNL_3.17e-11_10gev'] = ROOT.kRed+2
colors['HNL_3.17e-11_10gev'] = ROOT.kBlue+2
...
plots['HNL'] = {'signal':{
					...
					'HNL_4e-10_10gev':['HNL_4e-10_10gev'],
					'HNL_6.67e-10_10gev':['HNL_6.67e-10_10gev'],
					'HNL_8.35e-9_10gev':['HNL_8.35e-9_10gev'],
					'HNL_2.27e-9_10gev':['HNL_2.27e-9_10gev'],
                    'HNL_1.04e-8_10gev':['HNL_1.04e-8_10gev'],
					'HNL_2.27e-9_10gev':['HNL_2.27e-9_10gev'],
					'HNL_3.17e-11_10gev':['HNL_3.17e-11_10gev'],
					'HNL_3.17e-11_10gev':['HNL_3.17e-11_10gev'],
...
legend['HNL_4e-10_10gev'] = 'U^{2}=4e-10, M_{N}=20 GeV'
legend['HNL_4e-10_10gev'] = 'U^{2}=4e-10, M_{N}=80 GeV'
legend['HNL_6.67e-10_10gev'] = 'U^{2}=6.67e-10, M_{N}=30 GeV'
legend['HNL_8.35e-9_10gev'] = 'U^{2}=8.35e-9, M_{N}=40 GeV'
legend['HNL_2.27e-9_10gev'] = 'U^{2}=2.27e-9, M_{N}=20 GeV'
legend['HNL_1.04e-8_10gev'] = 'U^{2}=1.04e-8, M_{N}=70 GeV'
legend['HNL_2.27e-9_10gev'] = 'U^{2}=2.27e-9, M_{N}=50 GeV'
legend['HNL_3.17e-11_10gev'] = 'U^{2}=3.17e-11, M_{N}=30 GeV'
legend['HNL_3.17e-11_10gev'] = 'U^{2}=3.17e-11, M_{N}=60 GeV'
