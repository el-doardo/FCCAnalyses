...
outdir         = '/eos/user/e/espoto/H_pole/FCCAnalyses/reco/plots_reco/HNL_30gev/'
formats        = ['png']
#formats        = ['pdf']
#yaxis          = ['lin','log']
yaxis          = ['log']
...
colors['HNL_4e-10_30gev'] = ROOT.kAzure+5
colors['HNL_6.67e-10_30gev'] = ROOT.kBlue-7
colors['HNL_8.35e-9_30gev'] = ROOT.kOrange-2
colors['HNL_2.27e-9_30gev'] = ROOT.kOrange+8
